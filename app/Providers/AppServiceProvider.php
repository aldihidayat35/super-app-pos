...
use App\Policies\CustomerPriceOverridePolicy;
...
use App\Policies\StaffBonusResultPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(CustomerPriceOverride::class, CustomerPriceOverridePolicy::class);
        ...
        Gate::policy(WorkChecklist::class, WorkChecklistPolicy::class);
        Gate::policy(StaffBonusResult::class, StaffBonusResultPolicy::class);

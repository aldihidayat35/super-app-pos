...
class DashboardReportTest extends TestCase
{
    ...
    public function test_daily_report_renders_distinct_retail_and_warehouse_views(): void
    {
        ...
        $this->actingAs($this->owner)
            ...
            ->assertOk()
            ->assertSee('Analisis penjualan POS, margin, kasir, metode pembayaran, dan kesiapan stok toko.')
        ...
        $this->actingAs($this->owner)
            ...
            ->assertOk()
            ->assertSee('Analisis posisi persediaan, stok kritis, dan pergerakan barang gudang.')

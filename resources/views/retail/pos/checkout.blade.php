...
@section('content')
    <x-metronic.card title="Checkout Manual">
        ...
        <form method="POST" action="{{ route('retail.pos.store') }}" class="row g-3">
            ...
            <div class="col-md-2"><x-metronic.form-group name="items.0.quantity" label="Qty" required><input type="number" step="1" min="1" name="items[0][quantity]" value="1" class="form-control"></x-metronic.form-group></div>

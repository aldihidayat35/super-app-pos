...
<body onload="window.print()">
    ...
    @foreach(['opening_cash'=>'Modal Awal','cash_sales'=>'Penjualan Tunai','non_cash_sales'=>'Non Tunai','receivable_sales'=>'Piutang','refunds'=>'Refund Pelanggan','supplier_refunds'=>'Refund Pemasok','expenses'=>'Expense','expected_cash'=>'Expected Cash','actual_cash'=>'Actual Cash','difference'=>'Selisih'] as $key => $label)

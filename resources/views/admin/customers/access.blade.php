...
@section('page_guide')
    <x-metronic.page-guide id="admin-customer-access" title="Panduan Alamat & Pengguna B2B">
        ...
        <x-slot:parts><ul><li><strong>Alamat Kirim:</strong> label, PIC, telepon, alamat lengkap, kota, kode pos, petunjuk.</li><li><strong>User Langganan:</strong> nama, username, akun utama/staf pelanggan, status aktif.</li></ul></x-slot:parts>

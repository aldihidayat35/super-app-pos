    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade" id="tab_stock">
            <x-metronic.card title="Pengaturan Stok">
                <div class="row">
                    <div class="col-md-4"><x-metronic.form-group name="minimum_order" label="Minimum Order"><input type="number" step="0.0001" min="0" name="minimum_order" value="{{ old('minimum_order', $product->minimum_order ?? 0) }}" class="form-control"></x-metronic.form-group></div>
                    <div class="col-md-4"><x-metronic.form-group name="minimum_stock" label="Minimum Stock"><input type="number" step="0.0001" min="0" name="minimum_stock" value="{{ old('minimum_stock', $product->minimum_stock ?? 0) }}" class="form-control"></x-metronic.form-group></div>
                    <div class="col-md-4"><x-metronic.form-group name="safety_stock" label="Safety Stock"><input type="number" step="0.0001" min="0" name="safety_stock" value="{{ old('safety_stock', $product->safety_stock ?? 0) }}" class="form-control"></x-metronic.form-group></div>

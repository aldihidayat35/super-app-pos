...
<aside id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" aria-label="Navigasi utama">
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        <div class="app-sidebar-wrapper hover-scroll-overlay-y my-3 px-3" data-kt-scroll="true" data-kt-scroll-height="100%" data-kt-scroll-save-state="true">
                        ...
                        <div class="menu-item menu-accordion {{ $isOpen ? 'here show' : '' }}" data-kt-menu-trigger="click">
                            ...
                            <div class="menu-sub menu-sub-accordion {{ $isOpen ? 'show' : '' }}">
                                @foreach ($children as $child)
                                    <div class="menu-item">
                                        <a class="menu-link {{ request()->routeIs(...$child['active']) ? 'active' : '' }}" href="{{ route($child['route']) }}">

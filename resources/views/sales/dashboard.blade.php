...
@php
    $showTargets = !in_array('sales.targets.index', config('ui_visibility.hidden_navigation_routes', []), true);
@endphp
...
@section('page_guide')
    <x-metronic.page-guide id="sales-dashboard" title="Panduan Dashboard Sales">
        <x-slot:function><p>Memantau penjualan dari order B2B yang sudah selesai, jumlah order, dan customer periode berjalan.</p></x-slot:function>
        <x-slot:workflow><ol><li>Buat order untuk customer Anda.</li><li>Gudang memproses order sampai selesai.</li><li>Order berstatus Selesai masuk ke ringkasan penjualan.</li></ol></x-slot:workflow>
        <x-slot:parts><ul><li>Kartu metrik menampilkan ringkasan penjualan bulan ini.</li><li>Order terbaru menampilkan status order dan pengiriman.</li></ul></x-slot:parts>
...
@section('content')
    ...
    <div class="row g-5 mb-5">
        ...
        @endif
        <div class="{{ $showTargets ? 'col-lg-4' : 'col-lg-12' }}">

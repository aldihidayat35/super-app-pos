...
<!--begin::Preview-->
<a 
	href="/metronic8/demo38/?page=apps/projects/list" 
	data-kt-href="true" 
...
<!--begin::Preview-->
<a 
	href="/metronic8/demo38/?page=apps/ecommerce/catalog/products" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="/metronic8/demo38/?page=apps/customers/list" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="/metronic8/demo38/?page=apps/subscriptions/list" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="/metronic8/demo38/?page=apps/user-management/users/list" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="/metronic8/demo38/?page=apps/invoices/create" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="/metronic8/demo38/?page=apps/support-center/overview" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="/metronic8/demo38/?page=apps/chat/private" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="/metronic8/demo38/?page=apps/calendar" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="/metronic8/demo38/?page=apps/file-manager/folders" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="/metronic8/demo38/?page=apps/inbox/listing" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
...
<!--begin::Preview-->
<a 
	href="/metronic8/demo38/?page=apps/contacts/getting-started" 
	data-kt-href="true" 
	class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden" 
>
	<!--begin::Title-->
